...
export const LandingPage = ({ onStart, onStartQuiz, onViewQuality }: LandingPageProps) => {
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6 sm:space-y-8">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                Nederlandse
                <br />
                <span className="bg-gradient-primary bg-clip-text text-transparent">AI Kieswijzer</span>
              </h1>
              ...
              <div className="flex items-center justify-center sm:justify-start gap-2 text-muted-foreground text-sm sm:text-base">
                ...
                <span>
                  {countLoading ? "Laden..." : `${((usageCount + 1000) * 2).toLocaleString("nl-NL")} keer gebruikt`}
                </span>
              </div>

              {/* Version */}
              <div className="flex items-center justify-center sm:justify-start text-muted-foreground text-sm sm:text-base"></div>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <Card className="p-6 text-center">
            ...
            <p className="text-muted-foreground">
              Transparante vergelijking van partijstandpunten via AI-analyse van officiële programma's en stemgedrag.
            </p>
          </Card>
          ...
          <Card className="p-6 text-center">
            ...
            <p className="text-muted-foreground">
              Alle bronnen worden getoond. Antwoorden zijn gebaseerd op verifieerbare verkiezingprgramma's.
            </p>
          </Card>
          ...
          <Card className="p-6 text-center">
            ...
            <p className="text-muted-foreground">
              Bijgewerkte onderdelen: stemwijzervragen: 21 okt, prompts 4 okt, database: 13 sept, chatlayout 2 okt.
            </p>
          </Card>
          <Button
            size="lg"
            variant="outline"
            className="text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 min-h-[48px] bg-gradient-to-r from-yellow-50 to-orange-50 hover:from-yellow-100 hover:to-orange-100 border-2 border-yellow-200 hover:border-yellow-300"
            onClick={onViewQuality}
          >
            Data kwaliteit
          </Button>
          <span>versie: 0.84 – vragen: diederik@southparc.nl</span>
        </div>
      </div>
    </div>
  );
